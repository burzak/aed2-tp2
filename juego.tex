...
\subsubsection{Justificación}
	...
	\begin{Tupla}[InfoJugador]
		...
		\tupItem{posicionMapa}{$it_lista$(tupla<jugador: Nat, EsperandoCapturar: $it_ColaDePrioridad$(cantPokemon)>)}
	...
	\begin{Tupla}[CosaFea]
		...
		\tupItem{jugadores}{ListaEnlazada(jugador, $it_ColaDePrioridad$(cantPokemon))}
